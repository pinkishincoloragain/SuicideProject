...
#abstracts, drugs, queries = get_abstracts_pubmed.main(email="???",druglist_path="data/Drug_mapping_v2.xlsx", columns=["ingredient", "ingredient_1"], max_results=100000,  suicide_mesh=True,suicide_tw=True, case_report=True)

abstracts, drugs, queries = get_abstracts_pubmed.main(email="???",druglist_path="data/Drug_mapping_v2.xlsx", columns=["ingredient", "ingredient_1"],max_results=100000,  suicide_mesh=True,suicide_tw=True, case_report=True,  from_date="1990/01/01", to_date="2021/07/07", lang=["English"])
